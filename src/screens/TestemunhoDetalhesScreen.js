...
const styles = StyleSheet.create({
  ...
  actionTitle: { fontFamily: 'Inter', fontSize: 16, fontWeight: '700', color: '#FFFFFF', marginBottom: 4 },
  actionSubtitle: { fontFamily: 'Inter', fontSize: 13, fontWeight: '400', color: 'rgba(255, 255, 255, 0.9)', lineHeight: 18 },
  actionButton: { backgroundColor: '#FFFFFF', flexDirection: 'row', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 24, borderRadius: 16, gap: 6 },
  ...
  statLabel: { fontFamily: 'Inter', fontSize: 12, fontWeight: '400', color: '#94A3B8', marginTop: 2 },
